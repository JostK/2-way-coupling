SUBROUTINE WriteOFtoOCW3D_Eta
!
! Writes the free surface elevation and velocities calculated by OpenFOAM to the OCW3D solution
!
! By Jost Kemper
USE GlobalVariables, ONLY: WaveField, OfPoints, EOF, alpha, beta, gamma, FineGrid,& 
...
Write(*,*) 'Writing OpenFOAM solution to OceanWave3D (Eta only)'
...
END SUBROUTINE WriteOFtoOCW3D_Eta
