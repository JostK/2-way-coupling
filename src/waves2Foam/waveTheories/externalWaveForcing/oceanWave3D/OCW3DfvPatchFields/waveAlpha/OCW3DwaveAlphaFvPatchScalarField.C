...
#include "OCW3DwaveAlphaFvPatchScalarField.H"
...
OCW3DwaveAlphaFvPatchScalarField::OCW3DwaveAlphaFvPatchScalarField
(
    const fvPatch& p,
...
OCW3DwaveAlphaFvPatchScalarField::OCW3DwaveAlphaFvPatchScalarField
(
    const OCW3DwaveAlphaFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void OCW3DwaveAlphaFvPatchScalarField::signedPointToSurfaceDistance
(
    const pointField& pp,
    scalarField& sd
)
...
scalar OCW3DwaveAlphaFvPatchScalarField::signedPointToSurfaceDistance
(
    const point& pp
) const
{
...
void OCW3DwaveAlphaFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void OCW3DwaveAlphaFvPatchScalarField::evaluate()
{
    if (!this->updated())
    {
        this->updateCoeffs();
...
// Write
void OCW3DwaveAlphaFvPatchScalarField::write(Ostream& os) const
{
