...
namespace Foam
{
    defineTypeNameAndDebug(OCWpatchProbes, 0);
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::OCWpatchProbes::findElements(const fvMesh& mesh)
{
...
Foam::OCWpatchProbes::OCWpatchProbes
(
    const word& name,
...
:
    OCWprobes(name, obr, dict, loadFromFiles)
{
...
void Foam::OCWpatchProbes::write()
{
...
void Foam::OCWpatchProbes::read(const dictionary& dict)
{
